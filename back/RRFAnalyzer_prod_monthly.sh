...
python3 $PATH_SCRIPT/RRFAnalyzer.py --room ALL --month -11 --format JSON > $PATH_LOG/RRFAnalyzer_m11.json
python3 $PATH_SCRIPT/RRFAnalyzer.py --room ALL --month -12 --format JSON > $PATH_LOG/RRFAnalyzer_m12.json
